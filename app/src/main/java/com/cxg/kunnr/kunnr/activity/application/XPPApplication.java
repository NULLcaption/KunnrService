package com.cxg.kunnr.kunnr.activity.application;
...
public class XPPApplication extends Application {
    ...
    public enum PhotoType {
       KUNNRYD, SIGNIN, SIGNOUT
    }

    public static final String jxs_role = "jxs_role";
    public static final String jxscg_role = "jxscg_role";
